...
public class HangarManager : MonoBehaviour
{
    ...
    {
        GetComponent<HangarPopupController>().AddPopWin(allBuyWindow, 0, AllBuyWindowMethod);
    }

    void AllBuyWindowMethod()
    {
        int coinRest = ValueDeliverScript.coinRest;
    ...
    void GotoEquipWindowsReady01()
    {
        ...
        if (buddyPoint >= 100)
        {
            ...
            buddy100GetNextF = new Action(Buddy100GetRank1);    //later를 선택했을때 작동할 메소드를 지정한다//
            buddy100LaterNextF = new Action(Buddy100LaterFEquip1);  //get을 선택했을때 작동할 메소드를 지정한다//
        }
        else
        {
    ...
    void GotoEquipWindowsReady02()
    {
        ...
        {
            GetComponent<HangarPopupController>().AddPopWin(buddyPoint100, -1);
            buddy100GetNextF = new Action(Buddy100GetRank2);    //later를 선택했을때 작동할 메소드를 지정한다//
            buddy100LaterNextF = new Action(Buddy100LaterFEquip2);  //get을 선택했을때 작동할 메소드를 지정한다//
        }
        else
        {
    ...
    public void Flight001SkillUp()
    {
        ...
        if (flight001Skill < 5)
        {
            ...
            else
            {
                ...
                string lavel = "01";
                if (flight001Skill < 5) lavel = flight001Skill.ToString("D2"); else lavel = "MAX";
                flight001SkillLabel.GetComponent<UILabel>().text = lavel;
    ...
    {
        GetComponent<HangarPopupController>().AddPopWin(upgradePointWindow, 0, MCoinShortageWindowMethod);
    }
    ...
    void FriendRankTabSetting(RankDataS[] friendData, Transform parentT, bool isFB = true)
    {
        ...
        for (int i = 0; i < friendData.Length; i++)
        {
            ...
            else
            {
                ...
                Debug.Log(":: fuelTime + 30min :: " + fuelTime.AddMinutes(90));
