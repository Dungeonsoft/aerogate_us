...
public class FlightUpointSetScript : MonoBehaviour {
    ...
    {
        flight00PerLabel[0].text = F00ResultPoint0.ToString() + "%";
        flight00PerLabel[1].text = F00ResultPoint1.ToString() + "%";
        flight00PerLabel[2].text = F00ResultPoint2.ToString() + "%";
        flight00PerLabel[3].text = F00ResultPoint3.ToString() + "%";

        flight01PerLabel[0].text = F01ResultPoint0.ToString() + "%";
        flight01PerLabel[1].text = F01ResultPoint1.ToString() + "%";
        flight01PerLabel[2].text = F01ResultPoint2.ToString() + "%";
        flight01PerLabel[3].text = F01ResultPoint3.ToString() + "%";

        flight02PerLabel[0].text = F02ResultPoint0.ToString() + "%";
        flight02PerLabel[1].text = F02ResultPoint1.ToString() + "%";
        flight02PerLabel[2].text = F02ResultPoint2.ToString() + "%";
        flight02PerLabel[3].text = F02ResultPoint3.ToString() + "%";
    }
    ...
    {
        flight00BaseGage[0].fillAmount = ValueDeliverScript.pointF00P01 / 100f;
        flight00BaseGage[1].fillAmount = ValueDeliverScript.pointF00P02 / 100f;
        flight00BaseGage[2].fillAmount = ValueDeliverScript.pointF00P03 / 100f;
        flight00BaseGage[3].fillAmount = ValueDeliverScript.pointF00P04 / 100f;

        flight01BaseGage[0].fillAmount = ValueDeliverScript.pointF01P01 / 100f;
        flight01BaseGage[1].fillAmount = ValueDeliverScript.pointF01P02 / 100f;
        flight01BaseGage[2].fillAmount = ValueDeliverScript.pointF01P03 / 100f;
        flight01BaseGage[3].fillAmount = ValueDeliverScript.pointF01P04 / 100f;

        flight02BaseGage[0].fillAmount = ValueDeliverScript.pointF02P01 / 100f;
        flight02BaseGage[1].fillAmount = ValueDeliverScript.pointF02P02 / 100f;
        flight02BaseGage[2].fillAmount = ValueDeliverScript.pointF02P03 / 100f;
        flight02BaseGage[3].fillAmount = ValueDeliverScript.pointF02P04 / 100f;
    }

    //추가된 스탯양을 게이지바로 보여주기 위해 사용하는 함수.
    public void AddGageSet()
    {
        flight00AddGage[0].fillAmount = F00ResultPoint0 / 100f;
        flight00AddGage[1].fillAmount = F00ResultPoint1 / 100f;
        flight00AddGage[2].fillAmount = F00ResultPoint2 / 100f;
        flight00AddGage[3].fillAmount = F00ResultPoint3 / 100f;

        flight01AddGage[0].fillAmount = F01ResultPoint0 / 100f;
        flight01AddGage[1].fillAmount = F01ResultPoint1 / 100f;
        flight01AddGage[2].fillAmount = F01ResultPoint2 / 100f;
        flight01AddGage[3].fillAmount = F01ResultPoint3 / 100f;

        flight02AddGage[0].fillAmount = F02ResultPoint0 / 100f;
        flight02AddGage[1].fillAmount = F02ResultPoint1 / 100f;
        flight02AddGage[2].fillAmount = F02ResultPoint2 / 100f;
        flight02AddGage[3].fillAmount = F02ResultPoint3 / 100f;
    }
