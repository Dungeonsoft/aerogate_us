Shader "Custom/MissileRamp"
{
	Properties 
	{
_RimColor("_RimColor", Color) = (1,0.902507,0,1)
_RimPower("_RimPower", Range(0,5) ) = 2.6
...
float4 Subtract0=Tex2D0 - Multiply0;
